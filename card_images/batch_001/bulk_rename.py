...
for line in lines: 
    filenames.append(os.path.join(directory_path, batch_name, line.strip("\n")))
...
for datum in data:
    ...
    if "front.webp" in os.listdir(working_dir):
        os.replace(working_dir+"/front.webp", working_dir+"/thumb_front.webp")
    if "Back.png" in os.listdir(working_dir):
        os.replace(working_dir+"/Back.png", working_dir+"/back.png")
    if "Front.png" in os.listdir(working_dir):
        os.replace(working_dir+"/Front.png", working_dir+"/front.png")
    if "back.png" in os.listdir(working_dir):
        datum["back_art"] = batch_name + "/" + relative_filenames[counter] + "/back.png"
    if "front.png" in os.listdir(working_dir):
        datum["front_art"] = batch_name + "/" + relative_filenames[counter] + "/front.png"
    if "front.webp" in os.listdir(working_dir):
        datum["front_art"] = batch_name + "/" + relative_filenames[counter] + "/front.png"
    datum["pulled"] = False
    data[counter] = datum
